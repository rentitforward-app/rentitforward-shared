 ...
 */
export function getMaxApplicableCredit(totalAmount: number, maxCreditPercent: number = 0.50): number {
 ...
 */
export function applyCredit(pricing: PricingCalculation, creditAmount: number): PricingCalculation & { creditApplied: number; finalTotal: number } {
